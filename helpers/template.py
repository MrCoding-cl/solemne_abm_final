...
//======WEST TEAM======
robot EDU.gatech.cc.is.abstractrobot.SocSmallSim {team1}
...
//======EAST TEAM======
robot EDU.gatech.cc.is.abstractrobot.SocSmallSim {team2}
...
"""
    ## Write text to C:\Users\SlimeS\IdeaProjects\LabABM\Domains\SoccerBots\teams\robocup.dsc
    with open(robocuppath, "w") as text_file:
